...
- [Smashingmagazine](https://smashingmagazine.com)
- 💥[Сайты для практики вёрстки Frontend Practice](https://frontendpractice.com)
- 💥[Лёрн жс ру](https://learn.javascript.ru/)
## Frameworks
[Angulararchitects.io](https://www.angulararchitects.io/blog/)
...
---
## HTML
- [Puzzleweb](https://puzzleweb.ru) - Годный HTML справочник
- 💥 [Аксессибилити бесплатный курс egghead](https://egghead.io/courses/start-building-accessible-web-applications-today)
- [HTML справочник](https://puzzleweb.ru/)
...
---
## CSS
- 💥 [Коллекция 99 паттернов вёрстки](https://csslayout.io/patterns/)
- 💥 [every-layout.dev](https://every-layout.dev) - Хейдон Пикеринг и Энди Белл сделали что то типа ресурса лучших практик css
- 💥 [moderncss.dev](https://moderncss.dev) - современные решения старых проблем by Стефани Эклз
- 💥 [Ахмад Шадид: Grid для макетов. Flexbox - для компонентов](https://techrocks.ru/2020/09/21/css-grid-vs-flexbox/)
### Готовые элементы
- [Only css hamburger menu](https://codepen.io/andreykrokhin/pen/mGEqja)
### Transforms
- [3D transforms](https://3dtransforms.desandro.com/)
### Flexbox
- 💥 [Flexbox специифкация W3C](https://www.w3.org/TR/css-flexbox-1/)
- 💥 [CSS Tricks Flexbox - complete guide](https://css-tricks.com/snippets/css/a-guide-to-flexbox/) + крутые ссылки в разделе flexbox-tricks
- 💥[11 вещей flexbox](https://habr.com/ru/post/329820/)
...
- 💥 [Frontendmasters](https://frontendmasters.com/) - куча курсов 39$/мес
## REACT
- [Egghead beginners guide to react](https://egghead.io/courses/the-beginner-s-guide-to-react)
